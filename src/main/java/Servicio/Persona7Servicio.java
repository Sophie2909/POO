 ...
 * @author sacevedo
 */
public class Persona7Servicio {
  Scanner leer = (new Scanner(System.in)).useDelimiter("\n");
  
  public Persona7 crearPersona() {
    Persona7 persona1 = new Persona7();
    System.out.println("Ingrese su nombre: ");
    persona1.setNombre(this.leer.next());
    System.out.println("Ingrese su edad: ");
    persona1.setEdad(this.leer.nextInt());
    System.out.println("Ingrese su sexo(H - Hombre // M - Mujer // O - Otro): ");
    persona1.setSexo(this.leer.next().toUpperCase().charAt(0));
    ...
    persona1.setPeso(this.leer.nextDouble());
    System.out.println("Ingrese su altura: ");
    persona1.setAltura(this.leer.nextDouble());
    return persona1;
  }
  
  public int calcularIMC(Persona7 persona1) {
    int i = 0;
    double imc = persona1.getPeso() / Math.pow(persona1.getAltura(), 2.0D);
    if (imc < 20.0D) {
      i = -1;
    } else if (imc >= 20.0D && imc <= 25.0D) {
      i = 0;
    } else {
      i = 1;
    } 
