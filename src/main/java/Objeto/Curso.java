...
public class Curso {
  ...
  public String toString() {
    return "Curso[Nombre del Curso = " + this.nombreCurso + "]-[Cantidad de Horas Por Dia = " + this.cantidadHorasPorDia + "]-[Cantidad de Dias Por Semana = " + this.cantidadDiasPorSemana + "]-[Turno = " + this.turno + "]-[Precio Por Hora = $" + this.precioPorHora + "]";
  }
}
